...
public class MetaTileEntityLargeElectromagneticSeparator extends GCYMRecipeMapMultiblockController {

    public MetaTileEntityLargeElectromagneticSeparator(ResourceLocation metaTileEntityId) {
        super(metaTileEntityId, RecipeMaps.ELECTROMAGNETIC_SEPARATOR_RECIPES);
    }

    @Override
    public MetaTileEntity createMetaTileEntity(IGregTechTileEntity metaTileEntityHolder) {
        return new MetaTileEntityLargeElectromagneticSeparator(this.metaTileEntityId);
    }

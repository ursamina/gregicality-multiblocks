...
public class MetaTileEntityMegaFusionReactor extends GCYMRecipeMapMultiblockController {

    public MetaTileEntityMegaFusionReactor(ResourceLocation metaTileEntityId) {
        super(metaTileEntityId, RecipeMaps.FUSION_RECIPES);
    }

    @Override
    public MetaTileEntity createMetaTileEntity(IGregTechTileEntity metaTileEntityHolder) {
        return new MetaTileEntityMegaFusionReactor(this.metaTileEntityId);
    }

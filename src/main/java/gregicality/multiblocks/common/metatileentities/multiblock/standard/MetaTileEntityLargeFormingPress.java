...
public class MetaTileEntityLargeFormingPress extends GCYMRecipeMapMultiblockController {

    public MetaTileEntityLargeFormingPress(ResourceLocation metaTileEntityId) {
        super(metaTileEntityId, RecipeMaps.FORMING_PRESS_RECIPES);
    }

    @Override
    public MetaTileEntity createMetaTileEntity(IGregTechTileEntity metaTileEntityHolder) {
        return new MetaTileEntityLargeFormingPress(this.metaTileEntityId);
    }

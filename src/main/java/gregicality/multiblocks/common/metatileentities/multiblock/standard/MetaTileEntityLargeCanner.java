...
public class MetaTileEntityLargeCanner extends GCYMRecipeMapMultiblockController {

    public MetaTileEntityLargeCanner(ResourceLocation metaTileEntityId) {
        super(metaTileEntityId, RecipeMaps.CANNER_RECIPES);
    }

    @Override
    public MetaTileEntity createMetaTileEntity(IGregTechTileEntity metaTileEntityHolder) {
        return new MetaTileEntityLargeCanner(this.metaTileEntityId);
    }

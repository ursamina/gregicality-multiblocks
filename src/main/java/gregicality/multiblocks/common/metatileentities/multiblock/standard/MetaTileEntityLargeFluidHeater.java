...
public class MetaTileEntityLargeFluidHeater extends GCYMRecipeMapMultiblockController {

    public MetaTileEntityLargeFluidHeater(ResourceLocation metaTileEntityId) {
        super(metaTileEntityId, RecipeMaps.FLUID_HEATER_RECIPES);
    }

    @Override
    public MetaTileEntity createMetaTileEntity(IGregTechTileEntity metaTileEntityHolder) {
        return new MetaTileEntityLargeFluidHeater(this.metaTileEntityId);
    }
